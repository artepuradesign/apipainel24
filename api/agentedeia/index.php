...
// Limpa log anterior do mesmo CPF para evitar leitura de status antigo
...
echo json_encode([
    "status" => true,
    "cpf" => $cpf,
    "message" => "CPF recebido e em processamento no servidor",
    "log_file" => $logFile,
    "status_url" => "https://api.apipainel.com.br/agentedeia/status.php?cpf=" . urlencode($cpf)
]);
