            ...
            <div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  <Link key={i} to={item.to} className="group flex items-center gap-2 p-2 rounded-lg border border-white/10 bg-white/5 backdrop-blur-md hover:bg-white/10 hover:border-white/20 transition-all duration-300">
            ...
            <div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div key={i} className="group flex items-center gap-2 p-2 rounded-lg border border-white/10 bg-white/5 backdrop-blur-md hover:bg-white/10 hover:border-white/20 transition-all duration-300">
                    <div className={`flex items-center justify-center w-7 h-7 rounded-md bg-${item.color}-500/10`}>
                      <item.icon size={14} className={`text-${item.color}-400`} />
                    </div>
                    <div>
