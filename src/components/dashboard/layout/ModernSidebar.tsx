          ...
          return (
            ...
            >
              <NestedIcon className="h-4 w-4 shrink-0" />
                <span className="flex-1 min-w-0 text-left truncate whitespace-nowrap">{nestedItem.label}</span>
            </button>
          );
        })}
      </div>
          ...
          return (
            ...
            >
              ...
              >
                ...
                <span className="flex-1 min-w-0 text-left truncate whitespace-nowrap">{subItem.label}</span>
                {hasNestedSubItems && (
